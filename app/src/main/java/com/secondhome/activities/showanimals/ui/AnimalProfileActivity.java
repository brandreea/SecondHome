...
import com.secondhome.activities.showanimals.request.listener.GetAnimalListener;
...
public class AnimalProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    private void loadAnimalDetails() {
        ...
        StringRequest strReq= new StringRequest(
                Request.Method.POST, UrlForAnimal, new GetAnimalListener(getApplicationContext(),
                AnimalProfileActivity.this,this)
                , error -> {
